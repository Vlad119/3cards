...
namespace IAP
{
    public class InAppManager : MonoBehaviour, IStoreListener
    {
        ...
        public const string pNoAds = "noads";

        public const string pNoAdsAppStore = "noads";

        public const string pNoAdsGooglePlay = "gp_noads";
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            //Action for money
            //}
            if (String.Equals(args.purchasedProduct.definition.id, pNoAds, StringComparison.Ordinal))
            {
